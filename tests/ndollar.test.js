...
var triangle_raw = [[[94,109],[102,109],[110,109],[124,109],[145,109],[166,109],[193,109],[223,109],[251,109],[281,109],[311,109],[341,109],[373,109],[403,105],[421,105],[439,103],[451,103],[457,101]],[[433,124],[431,127],[428,132],[426,139],[422,147],[417,158],[407,179],[396,197],[388,218],[381,233],[377,242],[371,252],[368,260],[361,271],[356,281],[351,291],[345,305],[339,317],[335,331],[331,339],[329,348],[329,354],[327,360],[326,362],[326,364],[326,368],[326,370],[326,372],[326,375],[324,377],[323,378],[321,381],[318,383],[316,385],[313,388],[310,391],[306,394],[302,398],[297,402],[293,406],[289,411],[285,416],[281,421],[277,425],[273,429],[271,432],[269,434],[267,435],[266,436],[266,437],[265,437],[263,434]],[[104,112],[103,113],[103,115],[103,117],[103,120],[103,123],[103,125],[103,129],[103,133],[103,139],[107,146],[108,155],[112,166],[116,180],[120,193],[124,207],[127,221],[131,235],[137,252],[141,265],[147,278],[151,290],[156,301],[160,313],[165,322],[168,329],[172,336],[175,343],[179,347],[183,353],[185,357],[188,362],[191,365],[192,367],[193,371],[194,372],[196,374],[198,378],[200,381],[201,383],[201,387],[203,389],[204,393],[206,395],[207,397],[208,400],[212,404],[215,408],[217,410],[220,415],[224,418],[227,421],[229,424],[231,427],[233,430],[237,435],[238,436],[240,438],[243,442],[244,444],[245,445]]];
...
test('should recognize built-in shape: useBoundedRotationInvariance: false', () => {
  ...
  var result = recognizer.Recognize( P, useBoundedRotationInvariance, requireSameNoOfStrokes, useProtractor);
  ...
  result = recognizer.Recognize( P, useBoundedRotationInvariance, requireSameNoOfStrokes, useProtractor);
...
test('should recognize built-in shape: useBoundedRotationInvariance: true', () => {
  ...
  result = recognizer.Recognize( P, useBoundedRotationInvariance, requireSameNoOfStrokes, useProtractor);
  expect( result.Name ).toBe( "No match." );
});
...
test('should recognize custom shape', () => {
  ...
  var result = recognizer.Recognize( myHandDrawingOfTriangle, useBoundedRotationInvariance, requireSameNoOfStrokes, useProtractor);
